...
func (r *CheClusterReconciler) UpdateCheCRStatus(instance *orgv1.CheCluster, updatedField string, value string) (err error) {
...
func (r *CheClusterReconciler) UpdateCheCRSpecByFields(instance *orgv1.CheCluster, fields map[string]string) (err error) {
	updateInfo := []string{}
...
func (r *CheClusterReconciler) UpdateCheCRSpec(instance *orgv1.CheCluster, updatedField string, value string) (err error) {
	logrus.Infof("Updating %s CR with %s: %s", instance.Name, updatedField, value)
	err = r.client.Update(context.TODO(), instance)
	if err != nil {
		logrus.Errorf("Failed to update %s CR: %s", instance.Name, err.Error())
...
func (r *CheClusterReconciler) ReconcileIdentityProvider(instance *orgv1.CheCluster, isOpenShift4 bool) (deleted bool, err error) {
