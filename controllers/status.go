...
func (r *CheClusterReconciler) SetCheAvailableStatus(instance *orgv1.CheCluster, request reconcile.Request, protocol string, cheHost string) (err error) {
...
func (r *CheClusterReconciler) SetCheUnavailableStatus(instance *orgv1.CheCluster, request reconcile.Request) (err error) {
...
func (r *CheClusterReconciler) SetStatusDetails(instance *orgv1.CheCluster, request reconcile.Request, reason string, message string, helpLink string) (err error) {
...
func (r *CheClusterReconciler) SetCheRollingUpdateStatus(instance *orgv1.CheCluster, request reconcile.Request) (err error) {
